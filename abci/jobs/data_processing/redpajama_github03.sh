...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/redpajama_github03.$JOB_ID
...
python tools/preprocess_data.py \
        --input /bb/grandchallenge/gaf51090/datasets/redpajama_github/splitted/redpajama_github03.jsonl \
        --output-prefix $OUTDIR/redpajama_github03 \
