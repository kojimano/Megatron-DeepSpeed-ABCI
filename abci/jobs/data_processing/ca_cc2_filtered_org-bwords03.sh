...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/ca_cc2_filtered_org-bwords03.$JOB_ID
...
python tools/preprocess_data.py \
        --input /bb/grandchallenge/gaf51090/datasets/cacc/processed/ca_cc2_filtered_org-bwords03.jsonl \
        --output-prefix $OUTDIR/ca_cc2_filtered_org-bwords03 \
