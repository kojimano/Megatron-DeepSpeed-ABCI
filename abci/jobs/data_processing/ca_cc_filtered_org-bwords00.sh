...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/ca_cc_filtered_org-bwords00.$JOB_ID
...
python tools/preprocess_data.py \
        --input /bb/grandchallenge/gaf51090/datasets/cacc/processed/ca_cc_filtered_org-bwords00.jsonl \
        --output-prefix $OUTDIR/ca_cc_filtered_org-bwords00 \
