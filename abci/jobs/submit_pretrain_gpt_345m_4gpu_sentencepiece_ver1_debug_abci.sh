...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/pretrain_gpt_345m_4gpu_sentencepiece_ver1_debug_abci.$JOB_ID
...
sh abci/shells/pretrain_gpt_345m_4gpu_sentencepiece_ver1_debug_abci.sh
