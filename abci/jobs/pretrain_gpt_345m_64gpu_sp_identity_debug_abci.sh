...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/pretrain_gpt_345m_64gpu_sp_identity_debug_abci.$JOB_ID
...
sh abci/shells/pretrain_gpt_345m_64gpu_sp_identity_debug_abci.sh
