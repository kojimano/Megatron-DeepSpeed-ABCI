...
#$ -j y
#$ -cwd
#$ -o /bb/grandchallenge/gaf51090/job_outputs/pretrain_gpt_13b_544gpu_sp_identity_debug_abci_ver2.$JOB_ID
...
sh abci/shells/pretrain_gpt_13b_544gpu_sp_identity_debug_abci_ver2.sh
