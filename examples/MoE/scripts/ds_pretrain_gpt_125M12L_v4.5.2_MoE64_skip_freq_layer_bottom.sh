...
host="${HOSTNAME}"
NAME="gpt-${MODEL_SIZE}B-v4.5.2-bottomhalf-all2all-freq${ALL2ALL_FREQ}-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
