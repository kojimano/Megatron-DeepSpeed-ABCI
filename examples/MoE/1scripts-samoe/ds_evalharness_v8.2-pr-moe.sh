...
CHECKPOINT_PATH=/blob/users/minjiaz/project/moe/checkpoints/gpt-0.76B-v8.2-lr-1.8e-4-minlr-1e-6-bs-256-gpus-32-mp-1-pp-1/global_step50000/
...
RESULT_PATH=gpt-0.76B-v8.2-lr-1.8e-4-minlr-1e-6-bs-256-gpus-32-mp-1-pp-1
