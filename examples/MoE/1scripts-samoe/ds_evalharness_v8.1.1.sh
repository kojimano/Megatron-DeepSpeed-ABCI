...
CHECKPOINT_PATH=/blob/users/minjiaz/project/moe/checkpoints/gpt-0.76B-v8.1-lr-1.8e-4-minlr-1e-6-bs-256-gpus-32-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true/global_step50000/
...
RESULT_PATH=gpt-0.76B-v8.1.1-lr-1.8e-4-minlr-1e-6-bs-256-gpus-32-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true
...
# TASKS="lambada,triviaqa,webqs,piqa,race,boolq,copa,winogrande,arc_challenge,arc_easy,openbookqa,cb,copa,rte,wic,wsc,multirc,record,anli_r1,anli_r2,anli_r3"
...
# LAUNCHER="deepspeed --include worker-1:1"
LAUNCHER="deepspeed --include worker-1:0,1,2,3,4,5,6,7"
# LAUNCHER="deepspeed --include worker-1:1"
$LAUNCHER $CMD