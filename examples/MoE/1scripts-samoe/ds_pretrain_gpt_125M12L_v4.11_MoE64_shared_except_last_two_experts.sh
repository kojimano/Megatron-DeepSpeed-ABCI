...
host="${HOSTNAME}"
NAME="gpt-${MODEL_SIZE}B-v4.11-shared-except-last-two-experts-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
...
megatron_options=" \
        ...
        --shared-experts \
        --shared-except-last-two-experts \
