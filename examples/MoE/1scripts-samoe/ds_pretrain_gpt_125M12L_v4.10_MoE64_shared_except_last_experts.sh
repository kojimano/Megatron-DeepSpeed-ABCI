...
host="${HOSTNAME}"
NAME="gpt-${MODEL_SIZE}B-v4.10-shared-except-last-experts-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
