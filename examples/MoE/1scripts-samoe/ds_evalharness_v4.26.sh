...
CHECKPOINT_PATH=/blob/users/minjiaz/project/moe/checkpoints/gpt-0.125B-v4.26-L18-scaling-experts-shared-soft-learned-residual-lr-4.5e-4-minlr-4.5e-06-bs-256-gpus-32-mp-1-pp-1-ep-64-mlc-0.01-cap-1.0-drop-true/global_step572205/
...
RESULT_PATH=gpt-0.125B-v4.26-L18-scaling-experts-shared-soft-learned-residual-lr-4.5e-4-minlr-4.5e-06-bs-256-gpus-32-mp-1-pp-1-ep-64-mlc-0.01-cap-1.0-drop-true
...
# TASKS="lambada,triviaqa,webqs,winogrande,piqa,arc_challenge,arc_easy,openbookqa,race,boolq,cb,copa,rte,wic,wsc,multirc,record,anli_r1,anli_r2,anli_r3"
