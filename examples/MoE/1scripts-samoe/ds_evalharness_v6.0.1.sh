...
CHECKPOINT_PATH=/blob/users/minjiaz/project/moe/checkpoints/gpt-0.35B-v6.0.1-lr-2.0e-4-minlr-2e-06-bs-256-gpus-32-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true/global_step100000/
...
RESULT_PATH=gpt-0.35B-v6.0.1-lr-2.0e-4-minlr-2e-06-bs-256-gpus-32-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true
