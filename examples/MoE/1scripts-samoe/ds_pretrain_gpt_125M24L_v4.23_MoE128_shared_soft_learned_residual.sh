...
host="${HOSTNAME}"
NAME="gpt-${MODEL_SIZE}B-v4.23-L24-scaling-experts-shared-soft-learned-residual-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
