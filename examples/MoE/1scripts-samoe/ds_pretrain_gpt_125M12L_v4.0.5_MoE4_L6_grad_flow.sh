...
host="${HOSTNAME}"
NAME="gpt-${MODEL_SIZE}B-v4.0.4-grad-flow-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-mp-${MP_SIZE}-pp-${PP_SIZE}"
...
run_cmd="deepspeed --include worker-0:0,1,2,3,4,5,6,7 ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${OUTPUT_BASEPATH}/log/${NAME}_${host}.log"
