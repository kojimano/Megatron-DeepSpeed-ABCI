...
# Books Dataset: https://github.com/microsoft/Megatron-DeepSpeed/blob/azure/download_books.sh
BASE_PATH=/home/t-arpanjain/datasets/pile
...
if [ "${USE_INTERNAL_DATA}" = "true" ]; then
    ...
    DATA_BLEND=${BASE_PATH}/BookCorpusDataset_text_document
    VOCAB_PATH=${BASE_PATH}/gpt2-vocab.json
    MERGE_PATH=${BASE_PATH}/gpt2-merges.txt
...
launcher_options="--max_num_nodes ${MAX_NODES} \
                    --min_num_nodes ${MIN_NODES}  \
                    --force_multi --elastic_training \
